namespace VideoConverter
{
    ...
    public static class BundleConfig
    {
        ...
        private static void AddCss(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle(
               ...
               .Include("~/Content/css/main.min.css")
                .Include("~/images/ic/imgSprite.png.min.css")
               //.Include("~/Content/css/flags.css")
               );
        }
        ...
        private static void AddJavaScript(BundleCollection bundles)
        {
            ...
            Bundle alljqueryBundle = new ScriptBundle("~/bundles/alljquery")
                .Include("~/Scripts/jquery-2.1.4.min.js")
                .Include("~/Scripts/js/bootstrap.min.js")
                //.Include("~/Scripts/js/collapse.min.js")
                 .Include("~/Scripts/js/main.js")
                  .Include("~/Scripts/jquery.qrcode.js")
                   .Include("~/Scripts/qrcode.js");
             
            bundles.Add(alljqueryBundle);
